-- LENDX_SANDBOX.LENDX_DW.DIM_ORIGINATOR definition

create or replace TABLE LENDX_DW.DIM_ORIGINATOR (
	...
	STATE VARCHAR(256),
	AUDIT_LOADED_DATE TIMESTAMP_TZ(9),
	AUDIT_LAST_MODIFIED_DATE TIMESTAMP_TZ(9),
    CONSTRAINT PK_DIM_ORIGINATOR PRIMARY KEY (DIMENSION_KEY)
);

-- LENDX_SANDBOX.LENDX_DW.DIM_BORROWER definition

create or replace TABLE LENDX_DW.DIM_BORROWER (
	DIMENSION_KEY VARCHAR(32) NOT NULL,
	...
	STATE VARCHAR(32),
	ASSIGNED_ORIGINATOR_KEY VARCHAR(32),
    AUDIT_LOADED_DATE TIMESTAMP_TZ(9),
	AUDIT_LAST_MODIFIED_DATE TIMESTAMP_TZ(9),
    CONSTRAINT PK_DIM_BORROWER PRIMARY KEY (DIMENSION_KEY)
);

-- LENDX_SANDBOX.LENDX_DW.DIM_LOAN_PRODUCT definition

create or replace TABLE LENDX_DW.DIM_LOAN_PRODUCT (
	DIMENSION_KEY VARCHAR(32) NOT NULL,
...
-- LENDX_SANDBOX.LENDX_DW.DIM_LOAN_ACCOUNTS definition

CREATE OR REPLACE TABLE  LENDX_DW.FACT_LOAN_ACCOUNTS
(
    ...
    FUTURE_PAYMENTS_ACCEPTANCE VARCHAR(100),
    GUARANTORS VARIANT,
	...
	AUDIT_LAST_MODIFIED_DATE TIMESTAMP_TZ(9),
	NOTES VARCHAR(16777216),
	CONSTRAINT FK_DIM_ORIGINATOR FOREIGN KEY(DIM_ORIGINATOR) REFERENCES LENDX_SANDBOX.LENDX_DW.DIM_ORIGINATOR(DIMENSION_KEY),
	CONSTRAINT FK_DIM_LOAN_PRODUCT FOREIGN KEY(DIM_LOAN_PRODUCT) REFERENCES LENDX_SANDBOX.LENDX_DW.DIM_LOAN_PRODUCT(DIMENSION_KEY),
	CONSTRAINT FK_DIM_BORROWER FOREIGN KEY(DIM_BORROWER) REFERENCES LENDX_SANDBOX.LENDX_DW.DIM_BORROWER(DIMENSION_KEY),
	CONSTRAINT FK_DIM_TIME_APPROVED FOREIGN KEY(DIM_TIME_APPROVED) REFERENCES LENDX_SANDBOX.LENDX_DW.DIM_TIME(DIMENSION_KEY),
...
-- LENDX_DW.FACT_LOAN_REPAYMENTS definition

CREATE OR REPLACE TABLE LENDX_DW.FACT_LOAN_REPAYMENTS (
	FACT_KEY VARCHAR(32) NOT NULL,
	...
	AUDIT_LOADED_DATE TIMESTAMP_TZ(9),
	AUDIT_LAST_MODIFIED_DATE TIMESTAMP_TZ(9),
	CONSTRAINT FK_LOAN_REPAYMENTS_LOAN_ACCOUNTS FOREIGN KEY(FACT_LOAN_ACCOUNTS_FK) REFERENCES LENDX_SANDBOX.LENDX_DW.FACT_LOAN_ACCOUNTS(FACT_KEY),
	CONSTRAINT PK_FACT_LOAN_REPAYMENTS
        PRIMARY KEY (
        FACT_KEY
    )
);

-- LENDX_DW.FACT_LOAN_REPAYMENTS_HISTORY definition

CREATE OR REPLACE TABLE LENDX_DW.FACT_LOAN_REPAYMENTS_HISTORY (
	FACT_KEY VARCHAR(32) NOT NULL,
	FACT_LOAN_ACCOUNTS_FK VARCHAR(32) NOT NULL,
	DUE_DATE TIMESTAMP_TZ(9),
	ENCODED_KEY VARCHAR(32) NOT NULL,
